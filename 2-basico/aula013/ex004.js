...
document.body.innerHTML += `A segunda letra do seu nome é: <strong>${nome.trim()[1]}</strong> <br>`;
...
document.body.innerHTML += `As palavras do seu nome são: <strong>${nome.trim().split(' ')}</strong><br>`;
